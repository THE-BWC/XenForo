...
LABEL maintainer="Patrick Pedersen <patrick@patrickpedersen.tech> Black Widow Company <S-1@the-bwc.com>"
...
RUN echo "log_limit = 2048" >> /usr/local/etc/php-fpm.d/zzz-docker.conf
